    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
    			...
    			<select name="regular_price" id="input">

    			,<option value="0">Select Price</option>
    				@foreach ($products  as $regular_price)
    					<option value="{{ $regular_price->regular_price }}" {{ $regular_price->regular_price == $regular_price['regular_price'] ? 'selected' : '' }}>
                                ...
                                <div class="product product-style-3 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{route('product.details',['slug'=>$product->slug])}}" title="{{$product->name}}">
                                            <figure><img src="{{asset($product->product_image)}}" alt="{{$product->name}}"></figure>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <a href="{{route('product.details',['slug'=>$product->slug])}}" class="product-name"><span>{{$product->name}}</span></a>
                                        <div class="wrap-price"><span class="product-price">{{$product->regular_price
